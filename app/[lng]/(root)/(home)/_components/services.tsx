...
export default function Services() {
	return (
		<section className='max-w-6xl mx-auto my-10 max-md:px-3 '>
			<h1 className='text-2xl py-6 max-md:py-4 font-bold text-center'>
				Services
			</h1>
			<motion.div
			...
			>
				{services.map((service, idx) => (
					<motion.div
                       ...
                       rounded-2xl p-8 max-md:p-4 shadow-md hover:shadow-xl transition-shadow duration-300 border border-zinc-100 dark:border-zinc-800'
					>
